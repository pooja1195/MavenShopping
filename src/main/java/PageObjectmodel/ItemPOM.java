...
public class ItemPOM{
	...
	private By pr = By.xpath("(//span[contains(text(),'Apple iPhone 8 Plus - 64GB - All Colors - Fully Unlocked - Good Condition')])[3]");
	...
	private By alert = By.xpath("//button[@title='Close tooltip']");
